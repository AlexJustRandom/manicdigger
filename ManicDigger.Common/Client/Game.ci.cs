public class Game
{
    ...
    internal float MoveSpeedNow()
    {
        ...
        if (input.keyboardState[GetKey(GlKeys.ShiftLeft)])
        {
    ...
    internal void KeyDown(int eKey)
    {
        ...
        if (guistate == GuiState.Normal)
        {
            ...
            if (eKey == GetKey(GlKeys.F1))
            {
                ...
                {
                    Log(language.FreemoveNotAllowed());
                    return;
                }
    ...
    internal void MouseButtonChanged(bool mouseDown,MouseEventArgs args)
    {
        switch (args.GetButton()) {
            case (MouseButtonEnum.Middle):
                mouseMiddle = mouseDown;
                break;
            case (MouseButtonEnum.Left):
                mouseLeft = mouseDown;
                mouseleftclick = mouseDown;
                break;
            case (MouseButtonEnum.Right):
                mouseRight = mouseDown;
                mouserightclick = mouseDown;
                break;
        }
